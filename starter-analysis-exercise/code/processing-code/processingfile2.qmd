...
```{r}
# note, the original code assumes the 6 value represented feet, so it multiplies by 30.48 to convert.
#I've left this line here for historical sake, but overwritten for consistency with the above statement.
