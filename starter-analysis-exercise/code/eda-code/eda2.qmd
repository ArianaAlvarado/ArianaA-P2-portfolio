...
Creates a Boxplot of Height by Race.

```{r}
p5 <- mydata %>% ggplot(aes(x=Race, y=Height)) +
  geom_boxplot() +
  scale_x_discrete(labels = c('Black', 'Hispanic', 'Native American', 'Pacific Islander', 'White'))
plot(p5)
figure_file = here("starter-analysis-exercise","results","figures","height-race-boxplot.png")
ggsave(filename = figure_file, plot=p5) 
```

Creates a scatterplot of Age by Weight.

```{r}
p6 <- mydata %>% ggplot(aes(x=Weight, y=Age)) +
  geom_point()
plot(p6)
figure_file = here("starter-analysis-exercise","results","figures","weight-age-scatterplot.png")
